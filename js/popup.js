        ...
        String.format = function()
{
	...
	*/
	...
	function chkRadioPlayerState(funcFlag){
		...
		if(funcFlag){
			var timeOutID = chrome.extension.getBackgroundPage().gettimeOutID();
			timeOutID = setTimeout("chkRadioPlayerState(true)",1000);
